const send = (text: string, to: string) => {
	...
	const apiKey =
		"41393854744470492B444C6E31723350692F577873503634546344323133566D6A476B2B4E72736F4B31773D";
...
با توجه به ترافیک شدید تهران و شرایط جوی در فصل زمستان امکان تاخیر تا حداکثر ۴۵ دقیقه وجود دارد.
باتشکر؛نیلمان`;
	send(text, phoneNumber);
};
